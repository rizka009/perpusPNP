...
$review = $_GET["idReviews"];
$reviewData = queryReadData("SELECT * FROM member WHERE nisn = '$review'")[0];
...
<html lang="en">
  ...
  <body>
  <div class="d-flex justify-content-center mt-3 pt-5 m-5">
  ...
  <label for="validationCustom01" class="form-label">NIM</label>
  <div class="input-group mt-0">
    <input type="text" class="form-control" name="nisn" id="validationCustom01" value="<?= $reviewData["nisn"]?>" readonly>
    <div class="invalid-feedback">
        Kode member wajib diisi!
    </div>
  </div>
  ...
  <div class="input-group mt-0">
    ...
    <input type="text" class="form-control" id="validationCustom02" name="nama" value="<?= $reviewData["nama"]  ?>">
    <div class="invalid-feedback">
        Nama wajib diisi!
    </div>
  </div>
  ...
  <select class="form-select" id="inputGroupSelect01" name="jenis_kelamin">
    <option selected><?=  $reviewData["jenis_kelamin"] ?></option>
  ...
  <select class="form-select" id="inputGroupSelect01" name="jurusan">
    <option selected><?=  $reviewData["jurusan"] ?></option>
  ...
  <select class="form-select" id="inputGroupSelect01" name="kelas">
    <option selected><?=  $reviewData["kelas"] ?></option>
  ...
  <div class="input-group mt-0">
    ...
    <input type="number" class="form-control" name="no_tlp" id="validationCustom01" value="<?=  $reviewData["no_tlp"] ?>">
    <div class="invalid-feedback">
  ...
  <div class="col-12">
    ...
    <a class="btn btn-success" href="member.php">Batal</a>
