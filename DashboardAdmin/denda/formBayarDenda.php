...
<!DOCTYPE html>
  ...
  <div class="d-flex justify-content-center pt-5 mt-5 mb-5">
    <div class="card bg-warning bg-opacity-25 m-5 p-5">
    <form action="" method="post">
    <h3 class="text-center mb-3">Form bayar denda</h3>
    <hr>
      ...
      <a class="btn btn-danger text-tertiary" href="daftarDenda.php">Batal</a>
