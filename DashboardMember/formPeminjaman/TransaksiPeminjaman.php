...
<html lang="en">
  ...
  <div class="p-4 mt-3">
    <div class="mt-5 alert alert-secondary" role="alert">Riwayat transaksi Peminjaman Buku Anda - <span class="fw-bold text-capitalize"><?php echo htmlentities($_SESSION["member"]["nama"]); ?></span></div>
