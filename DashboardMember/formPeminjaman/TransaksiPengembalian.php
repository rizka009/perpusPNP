...
<html lang="en">
  ...
  <body>
    ...
    <div class="p-4 mt-3">
      <div class="mt-5 alert alert-secondary" role="alert">Riwayat transaksi Pengembalian Buku Anda - <span class="fw-bold text-capitalize"><?php echo htmlentities($_SESSION["member"]["nama"]); ?></span></div>
    <!--search engine 
    ...
    <table class="table table-striped table-hover">
      ...
      <tr>
        ...
        <th class="bg-warning bg-opacity-50 shadow-sm text-dark">Kategori</th>
