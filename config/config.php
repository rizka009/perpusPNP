...
function updateMember($dataMember) {
  ...
  $jeniskelamin = $dataMember["jenis_kelamin"];
  $kelas = htmlspecialchars($dataMember["kelas"]);
  $jurusan = htmlspecialchars($dataMember["jurusan"]);
  $notelp = htmlspecialchars($dataMember["no_tlp"]);
  //$tgldftr = $dataMember["tgl_pendaftaran"];
